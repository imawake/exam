...
(CASE WHEN users.nick_name is NULL THEN guest_name ELSE users.nick_name END) as displayName,
COUNT(guest_name) as score
...
<body>
<h1>5月のランキングの集計結果</h1> 
※guest_nameで集計しています</br>
&nbsp;&nbsp;「bs_mobilization」と「users」を「user_no」でJOINしていますが、</br>
&nbsp;&nbsp;「bs_mobilization」テーブルに「user_no = '00000000'」のレコードが複数存在するため</br>
&nbsp;&nbsp;「ナツォリ」が複数行存在するように見えています。</br></br>
